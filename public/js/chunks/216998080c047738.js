...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  methods: {
    initEventHandlers: function initEventHandlers() {
      ...
      this.videoPlayer.onended = this.onended; // this.videoPlayer.onwaiting = this.onwaiting;
    ...
    ontimeupdate: function ontimeupdate() {
      ...
      // );
      console.log("on time currentTime", this.videoPlayer.currentTime); // this.onapiCallRegisterPlayCount();
    },
