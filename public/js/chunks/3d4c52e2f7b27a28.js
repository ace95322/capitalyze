...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    playVideo: function playVideo(video) {
      ...
      console.log("this.videoPlayer => ", this.videoPlayer); //   this.createPlayCount();
    },
