...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
    ...
    return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _this.fetchVideos(); // this.initPlayer();
  ...
  methods: {
    initPlayer: function initPlayer() {
      ...
      console.log("video player obj", this.videoPlayer); //   this.initEventHandlers();
    },
    ...
    fetchVideos: function fetchVideos() {
      ...
      axios.get("/api/videos").then(function (res) {
        _this2.videos = res.data; // console.log('this.videos', this.videos)
      });
    }
  }
});
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  methods: {
    ...
    ontimeupdate: function ontimeupdate() {
      ...
      // );
      console.log("on time update", this.videoPlayer.duration); // this.onapiCallRegisterPlayCount();
    },
