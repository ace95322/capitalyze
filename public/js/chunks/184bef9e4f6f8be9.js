...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    playVideo: function playVideo(video) {
      ...
      this.hls = new Hls();
      this.videoPlayer = document.getElementById("video_player"); // this.videoPlayer.preload = "metadata";

      console.log("this.videoPlayer => ", this.videoPlayer); // this.videoPlayer.ontimeupdate = this.ontimeupdate();
