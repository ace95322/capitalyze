...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    playAble: function playAble(song) {
      console.log("Is require auth: " + _store_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].getters.getSettings.requireAuth);
      console.log("Get user: " + _store_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].getters.getUser);

      if (_store_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].getters.getSettings.requireAuth && !_store_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].getters.getUser) {
        this.loginOrCancel();
      } else {
        this.play(song, true);
      }
