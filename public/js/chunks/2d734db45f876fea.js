          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                // console.log("User: " + JSON.stringify(this.$store.getters.getUser.plan.free));
                console.log("User: " + JSON.stringify(_this4.$store.getters.getUser.is_admin));
                console.log("User plan: " + _this4.userPlan.free);
