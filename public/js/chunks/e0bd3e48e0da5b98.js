...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    playVideo: function playVideo(video) {
      ...
      this.hls = new Hls();
      this.videoPlayer = document.getElementById("video_player"); // this.audioPlayer.onloadstart = this.onloadstart;
      // this.audioPlayer.onerror = this.onerror;

      this.audioPlayer.onloadedmetadata = this.onloadmetadata; // this.audioPlayer.oncanplay = this.oncanplay;

      this.audioPlayer.ontimeupdate = this.ontimeupdate; // this.audioPlayer.onended = this.onended;
    ...
    ontimeupdate: function ontimeupdate() {
      ...
      console.log("this.audioPlayer.currentTime => ", this.audioPlayer.currentTime); // this.currentAudio.isPlaying = true
      // this.updateTime(
