  ...
  methods: {
    ...
    playVideo: function playVideo(video) {
      ...
      if (this.selected_video.source_format == "yt_video") {
        ...
        loadPlayer(video.source);
        alert("Hello");
        console.log("Call loadplayer method");
    ...
    onYouTubeIframeAPIReady: function onYouTubeIframeAPIReady() {
      console.log("onYouTubeIframeAPIReady"); //   var player = window.YT.Player("yt-player", {
      //     // events: {
      //     // 'onStateChange': onPlayerStateChange
      //     // }
      //   });

      loadPlayer("Xa0Q0J5tOP0"); //   console.log("player", player);
    },
...
function loadPlayer(videoId) {
  ...
  window.onYouTubeIframeAPIReady = function () {
    // onYouTubePlayer();
    console.log("onYouTubePlayerAPIReady", YT); // console.log("window.videocompo.onPlayerStateChange()",window.videocompo.onPlayerStateChange());
                ...
                _c(
                  ...
                  [
                    _c(
                      ...
                      [
                        _c("div", { staticClass: "content-item__body__type" }, [
                          _vm._v(
                            "\n                " +
                              _vm._s(_vm.$t("Video")) +
                              "\n              "
