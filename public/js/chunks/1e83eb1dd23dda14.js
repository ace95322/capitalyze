        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                if (!(_this4.$store.getters.getUser && _this4.$store.getters.isLogged && playlist.songs[0].is_only_for_subscriber && _this4.$store.getters.getUser.plan.free && !_this4.$store.getters.getUser.is_admin)) {
                  _context.next = 7;
                  break;
                }
