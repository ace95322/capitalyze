...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    playVideo: function playVideo(video) {
      ...
      console.log("selected video => ", this.selected_video.source_format);
      this.selected_video.custom_source = source;

      if (this.selected_video.source_format == 'yt_video') {
        this.selected_video.custom_source = 'https://www.youtube.com/embed/' + source;
      }
    },
