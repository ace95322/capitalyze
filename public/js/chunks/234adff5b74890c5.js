  ...
  methods: {
    ...
    playAble: function playAble(playlist, shouldQueue) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var _playlist$songs, _playlist$songs2;

        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                console.log("Optional check: " + ((_playlist$songs = playlist.songs) === null || _playlist$songs === void 0 ? void 0 : _playlist$songs[0].is_only_for_subscriber));
              ...
              case 4:
                if (!(_this4.$store.getters.getUser && _this4.$store.getters.isLogged && ((_playlist$songs2 = playlist.songs) === null || _playlist$songs2 === void 0 ? void 0 : _playlist$songs2[0].is_only_for_subscriber) !== undefined && _this4.$store.getters.getUser.plan.free && !_this4.$store.getters.getUser.is_admin)) {
                  _context.next = 8;
                  break;
                }
