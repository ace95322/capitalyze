...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    playAble: function playAble(album) {
      var _this3 = this;
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (!(!_this3.$store.getters.getUser && !_this3.$store.getters.isLogged)) {
                  _context.next = 3;
                  break;
                }

                _context.next = 3;
                return _this3.loginOrCancel();

              case 3:
                if (!(_this3.$store.getters.getUser && _this3.$store.getters.isLogged && album.is_only_for_subscriber && _this3.$store.getters.getUser.plan.free && !_this3.$store.getters.getUser.is_admin)) {
                  _context.next = 7;
                  break;
                }

                return _context.abrupt("return", new Promise(function (res, rej) {
                  vue__WEBPACK_IMPORTED_MODULE_1__["default"].$confirm({
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    playAble: function playAble(playlist, shouldQueue) {
      var _this4 = this;
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (!(!_this4.$store.getters.getUser && !_this4.$store.getters.isLogged)) {
                  _context.next = 3;
                  break;
                }

                _context.next = 3;
                return _this4.loginOrCancel();

              case 3:
                if (!(_this4.$store.getters.getUser && _this4.$store.getters.isLogged && ((_playlist$songs = playlist.songs) === null || _playlist$songs === void 0 ? void 0 : _playlist$songs[0].is_only_for_subscriber) !== 'undefined' && _this4.$store.getters.getUser.plan.free && !_this4.$store.getters.getUser.is_admin && _this4.shouldCheckSubs)) {
                  _context.next = 7;
                  break;
                }

                return _context.abrupt("return", new Promise(function (res, rej) {
                  vue__WEBPACK_IMPORTED_MODULE_2__["default"].$confirm({
                    message: "You need to subscribe to play this song.",
                    button: {
                      no: "Cancel",
                      yes: "Subscribe"
              ...
              case 7:
                if (shouldQueue) {
                  _this4.$store.commit('pushIntoQueue', playlist);
                } else {
                  _this4.play(playlist, true);
                }
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                if (!(_this4.$store.getters.getUser && _this4.$store.getters.isLogged && song.is_only_for_subscriber && _this4.$store.getters.getUser.plan.free && !_this4.$store.getters.getUser.is_admin)) {
                  _context2.next = 7;
                  break;
                }
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/player/pages/video/Video.vue?vue&type=script&lang=js&":
/*!*******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/player/pages/video/Video.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _elements_other_ProductBtn_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../elements/other/ProductBtn.vue */ "./resources/js/components/elements/other/ProductBtn.vue");
Object(function webpackMissingModule() { var e = new Error("Cannot find module 'ovenplayer'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    ...
    axios.get("/api/videos/" + this.$route.params.id).then(function (res) {
  ...
  computed: {
    isLiked: function isLiked() {// if (this.song) {
  ...
  methods: {
    playVideo: function playVideo(video) {
      this.videoPlayer = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'ovenplayer'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())("video_player", {
        title: video.title,
        image: video.cover,
        file: video.source,
        autoStart: true
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (_this2.isLiked) {
                  _this2.$store.dispatch("dislike", video);
                } else {
                  _this2.$store.dispatch("like", video);
                }
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_12_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_12_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_12_use_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Video_vue_vue_type_style_index_0_id_74882ece_lang_scss___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!../../../../../../node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12.use[3]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Video.vue?vue&type=style&index=0&id=74882ece&lang=scss& */ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12.use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/player/pages/video/Video.vue?vue&type=style&index=0&id=74882ece&lang=scss&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_12_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_12_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_12_use_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Video_vue_vue_type_style_index_0_id_74882ece_lang_scss___WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/* harmony import */ var _Video_vue_vue_type_style_index_0_id_74882ece_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Video.vue?vue&type=style&index=0&id=74882ece&lang=scss& */ "./resources/js/components/player/pages/video/Video.vue?vue&type=style&index=0&id=74882ece&lang=scss&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
/***/ "./resources/js/components/player/pages/video/Video.vue?vue&type=style&index=0&id=74882ece&lang=scss&":
/*!************************************************************************************************************!*\
  !*** ./resources/js/components/player/pages/video/Video.vue?vue&type=style&index=0&id=74882ece&lang=scss& ***!
  \************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_12_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_12_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_12_use_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Video_vue_vue_type_style_index_0_id_74882ece_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/style-loader/dist/cjs.js!../../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!../../../../../../node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12.use[3]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Video.vue?vue&type=style&index=0&id=74882ece&lang=scss& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12.use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/player/pages/video/Video.vue?vue&type=style&index=0&id=74882ece&lang=scss&");
...
var render = function render() {
  ...
  }), 0)]) : _vm._e(), _vm._v(" "), _vm.searchResults && _vm.searchResults.videos.length ? _c("div", {
    staticClass: "search-category"
  }, [_c("div", {
    staticClass: "category-title"
  }, [_vm._v("\n            " + _vm._s(_vm.$t("Videos")) + "\n          ")]), _vm._v(" "), _c("div", {
    staticClass: "category-results"
  }, _vm._l(_vm.searchResults.videos.slice(0, 3), function (video) {
    return _c("div", {
      key: video.id,
      staticClass: "search-result",
      on: {
      ...
      staticClass: "asset-artists"
    }, [_vm._v("\n                  " + _vm._s(_vm.getArtists(video.artists)) + "\n                ")])])]);
  ...
  }), 0)]) : _vm.searchResults && (_vm.searchResults.podcasts && !_vm.searchResults.podcasts.length || !_vm.searchResults.podcasts) && !_vm.searchResults.radioStations.length && !_vm.searchResults.albums.length && !_vm.searchResults.videos.length && !_vm.searchResults.playlists.length && !_vm.searchResults.songs.length && !_vm.searchResults.artists.length && !_vm.searchResults.users.length ? _c("div", {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn() {
        return [_c("div", {
          ...
          on: {
            click: function click($event) {
              _vm.playAble(_vm.playlist.songs, true);
      ...
      fn: function fn() {
        return [_c("div", {
          ...
          on: {
            click: function click($event) {
              return _vm.playAble(_vm.playlist);
            }
          }
        }, [_c(vuetify_lib_components_VIcon__WEBPACK_IMPORTED_MODULE_1__["default"], {
          attrs: {
      ...
      fn: function fn() {
        return [_vm.editPlaylist ? _c("edit-playlist", {
          ...
          attrs: {
            ...
            subscriptionCheck: _vm.shouldCheckSubs,
            headers: "true",
            ranked: "true"
          },
          on: {
...
var render = function render() {
  ...
  return _vm.video ? _c("div", {
    ...
    staticClass: "cover-img",
    style: {
      backgroundImage: "url(" + _vm.video.cover + ")"
    }
  }, [_c("div", {
    staticClass: "overlay"
  }), _vm._v(" "), _c("div", {
    ...
    staticClass: "song-infos"
  }, [_c("h3", [_vm.video.album ? [_c("small", [_vm._v(_vm._s(_vm.$t("From")))]), _vm._v(" "), _c("router-link", {
    staticClass: "router-link router-link__white",
    attrs: {
      to: {
        name: "album",
        params: {
          id: _vm.video.album.id
        }
      }
    }
  }, [_vm._v("\n              " + _vm._s(_vm.video.album.title) + "\n            ")])] : _vm._e(), _vm._v(" "), _vm.video.artists && _vm.video.artists.length ? [_c("small", [_vm._v(_vm._s(_vm.$t("By")))]), _vm._v(" "), _c("artists", {
    attrs: {
      artists: _vm.video.artists,
      textColor: "white"
    }
  })] : _vm._e()], 2)])], 1), _vm._v(" "), _c("div", {
    staticClass: "actions"
    ...
    staticClass: "play-button"
  }, [_vm.isCurrentlyPlaying(_vm.video) ? _c(vuetify_lib_components_VBtn__WEBPACK_IMPORTED_MODULE_1__["default"], {
    attrs: {
      color: "primary",
      "x-large": "",
      rounded: ""
    ...
    on: {
      click: function click($event) {
        return _vm.playVideo(_vm.video);
      }
    }
  }, [_c(vuetify_lib_components_VIcon__WEBPACK_IMPORTED_MODULE_2__["default"], {
    attrs: {
  ...
  }), _vm._v(" "), !_vm.$store.getters.getSettings.disableRegistration ? _c("div", [_vm.isLiked ? _c("div", {
    on: {
      click: function click($event) {
  ...
  }, [_vm._v("$vuetify.icons.heart-outline")])], 1)], 1)]) : _vm._e()], 1)], 1), _vm._v(" "), _vm.$store.getters.getSettings.enableAds ? [_c("div", {
    staticClass: "ad-slot"
  }, [_c("ad", {
    attrs: {
      ad_code: _vm.parseAd(_vm.$store.getters.getSettings.rect_ad).code
  ...
  })], 1)] : _vm._e(), _vm._v(" "), _vm._m(0)], 2)]) : !_vm.video && _vm.errorStatus == 404 ? _c("empty-page", {
    attrs: {
      headline: _vm.$t("Not Available!"),
      sub: _vm.$t("Video does not exist or maybe it is not available for public access. Who knows!"),
      img: "peep-68.png"
    },
    scopedSlots: _vm._u([{
      key: "button",
  ...
  }) : !_vm.video && _vm.errorStatus ? _c("empty-page", {
    attrs: {
      headline: _vm.$t("Something wrong happend!"),
      sub: _vm.$t("Some server error has occurred. Try again later."),
      img: "peep-68.png"
