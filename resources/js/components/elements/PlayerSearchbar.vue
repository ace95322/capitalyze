  ...
  <div class="searchbar-wrapper">
    <div class="searchbar">
      <input
        ...
        @input="search()"
      />
      <v-icon class="style-search-icon" light>$vuetify.icons.magnify</v-icon>
    </div>
    <div class="search-panel" v-if="showResultPanel" @click.stop>
      ...
      >
        ...
        <v-btn>
          <span>{{ $t("Videos") }}</span>
          <v-icon>$vuetify.icons.play-circle</v-icon>
        </v-btn>
        <v-btn>
          <span>{{ $t("Albums") }}</span>
      ...
      <div class="search-results-container">
        ...
        <template v-else-if="currentPage === 'top'">
          <div
            ...
            v-if="searchResults && searchResults.radioStations.length"
          >
            ...
            <div class="category-results">
              ...
              >
                <div class="cover">
                  <v-img :src="radioStation.cover" width="50" height="50">
          ...
          >
            ...
            <div class="category-results">
              ...
              >
                <div class="cover">
                  <v-img :src="song.cover" width="50" height="50">
                    <template v-slot:placeholder>
                      <content-placeholders :rounded="true">
                        <content-placeholders-img
                          class="small-image-skeleton"
          ...
          <div
            class="search-category"
            v-if="searchResults && searchResults.videos.length"
          >
            <div class="category-title">
              {{ $t("Videos") }}
            </div>
            <div class="category-results">
              <div
                class="search-result"
                v-for="video in searchResults.videos.slice(0, 3)"
                :key="video.id"
                @click.stop="
                  goToSearchRoute({
                    id: video.id,
          ...
          >
            ...
            <div class="category-results">
              <div
                class="search-result"
                v-for="artist in searchResults.artists.slice(0, 3)"
                :key="artist.id"
                @click.stop="
                  goToSearchRoute({
                    id: artist.id,
              ...
              >
                <div class="cover">
                  <v-img :src="artist.avatar" width="50" height="50">
                    <template v-slot:placeholder>
                      <content-placeholders :rounded="true">
                        <content-placeholders-img
                          class="small-image-skeleton"
          ...
          >
            ...
            <div class="category-results">
              <div
                class="search-result"
                v-for="album in searchResults.albums.slice(0, 3)"
                :key="album.id"
                @click.stop="
                  goToSearchRoute({
                    id: album.id,
              ...
              >
                <div class="cover">
                  <v-img :src="album.cover" width="50" height="50">
                    <template v-slot:placeholder>
                      <content-placeholders :rounded="true">
                        <content-placeholders-img
                          class="small-image-skeleton"
                ...
                <div class="body">
                  ...
                  <div class="asset-artists" v-if="album.artist">
          ...
          >
            ...
            <div class="category-results">
              <div
                class="search-result"
                v-for="podcast in searchResults.podcasts.slice(0, 3)"
                :key="podcast.id"
                @click.stop="
                  goToSearchRoute({
                    id: podcast.id,
              ...
              >
                <div class="cover">
                  <v-img :src="podcast.cover" width="50" height="50">
                    <template v-slot:placeholder>
                      <content-placeholders :rounded="true">
                        <content-placeholders-img
                          class="small-image-skeleton"
                ...
                <div class="body">
                  ...
                  <div class="asset-artists" v-if="podcast.artist">
          ...
          >
            ...
            <div class="category-results">
              <div
                class="search-result"
                v-for="playlist in searchResults.playlists.slice(0, 3)"
                :key="playlist.id"
                @click.stop="
                  goToSearchRoute({
                    id: playlist.id,
              ...
              >
                <div class="cover">
                  <v-img :src="playlist.cover" width="50" height="50">
                    <template v-slot:placeholder>
                      <content-placeholders :rounded="true">
                        <content-placeholders-img
                          class="small-image-skeleton"
          ...
          >
            ...
            <div class="category-results">
              ...
              >
                <div class="cover">
                  <v-img :src="user.avatar" width="50" height="50">
                    <template v-slot:placeholder>
                      <content-placeholders :rounded="true">
                        <content-placeholders-img
                          class="small-image-skeleton"
          ...
          <div
            ...
            v-else-if="
              searchResults &&
              ((searchResults.podcasts && !searchResults.podcasts.length) ||
        ...
        <template v-else-if="searchResults">
          ...
          <template v-if="currentPage === 'songs'">
            <div class="search-results" v-if="searchResults.songs.length">
              <div
                class="search-result"
          ...
          <template v-if="currentPage === 'playlists'">
            <div class="search-results" v-if="searchResults.playlists.length">
              <div
                class="search-result"
          ...
          <template v-if="currentPage === 'podcasts'">
            <div class="search-results" v-if="searchResults.podcasts.length">
              <div
                class="search-result"
          ...
          <template v-if="currentPage === 'artists'">
            <div class="search-results" v-if="searchResults.artists.length">
              <div
                class="search-result"
          ...
          <template v-if="currentPage === 'users'">
            <div class="search-results" v-if="searchResults.users.length">
              <div
                class="search-result"
